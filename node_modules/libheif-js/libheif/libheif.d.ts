...
interface WasmModule {
  ...
  _heif_image_handle_has_content_light_level(_0: number): number;
  ...
  _heif_image_handle_has_mastering_display_colour_volume(_0: number): number;
  ...
  _heif_image_has_ambient_viewing_environment(_0: number): number;
  _heif_image_handle_has_ambient_viewing_environment(_0: number): number;
  _heif_image_get_ambient_viewing_environment(_0: number, _1: number): number;
  _heif_image_handle_get_ambient_viewing_environment(_0: number, _1: number): number;
  _heif_image_set_ambient_viewing_environment(_0: number, _1: number): void;
  _heif_image_handle_set_ambient_viewing_environment(_0: number, _1: number): void;
  _heif_image_has_nominal_diffuse_white_luminance(_0: number): number;
  _heif_image_get_nominal_diffuse_white_luminance(_0: number): number;
  _heif_image_set_nominal_diffuse_white_luminance(_0: number, _1: number): void;
  _heif_image_handle_has_nominal_diffuse_white_luminance(_0: number): number;
  _heif_image_handle_get_nominal_diffuse_white_luminance(_0: number): number;
  _heif_image_handle_set_nominal_diffuse_white_luminance(_0: number, _1: number): void;
  ...
  _heif_image_set_bayer_pattern(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number): void;
  _heif_image_add_bayer_component(_0: number, _1: number, _2: number, _3: number): void;
  _heif_image_get_bayer_pattern_size(_0: number, _1: number, _2: number, _3: number): number;
  _heif_image_get_bayer_pattern(_0: number, _1: number, _2: number, _3: number): void;
  _heif_polarization_angle_no_filter(): number;
  _heif_polarization_angle_is_no_filter(_0: number): number;
  _heif_image_add_polarization_pattern(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number): void;
  _heif_image_get_number_of_polarization_patterns(_0: number): number;
  _heif_image_get_polarization_pattern_info(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number): void;
  _heif_image_get_polarization_pattern_data(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  _heif_image_get_polarization_pattern_index_for_component(_0: number, _1: number): number;
  _heif_image_add_sensor_bad_pixels_map(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number, _8: number, _9: number, _10: number): void;
  _heif_image_get_number_of_sensor_bad_pixels_maps(_0: number): number;
  _heif_image_get_sensor_bad_pixels_map_info(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number): void;
  _heif_image_get_sensor_bad_pixels_map_data(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number): void;
  _heif_image_add_sensor_nuc(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number, _8: number): void;
  _heif_image_get_number_of_sensor_nucs(_0: number): number;
  _heif_image_get_sensor_nuc_info(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number): void;
  _heif_image_get_sensor_nuc_data(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number): void;
  _heif_image_set_chroma_location(_0: number, _1: number, _2: number): void;
  _heif_image_has_chroma_location(_0: number): number;
  _heif_image_get_chroma_location(_0: number): number;
  ...
  _heif_context_get_sequence_duration(_0: number): number;
  ...
  _heif_track_get_number_of_repetitions(_0: number): number;
  ...
  _heif_sequence_encoding_options_copy(_0: number, _1: number): void;
  ...
  _heif_orientation_concat(_0: number, _1: number): number;
  ...
  _heif_context_set_unif(_0: number, _1: number): void;
  ...
  _heif_context_get_max_decoding_threads(_0: number): number;
  ...
  _heif_image_handle_set_gimi_content_id(_0: number, _1: number): void;
  _heif_image_handle_get_number_of_cmpd_components(_0: number): number;
  _heif_image_handle_get_cmpd_component_type(_0: number, _1: number): number;
  _heif_image_handle_get_cmpd_component_type_uri(_0: number, _1: number): number;
  _heif_image_handle_has_gimi_component_content_ids(_0: number): number;
  _heif_image_handle_get_gimi_component_content_id(_0: number, _1: number): number;
  _heif_image_handle_set_gimi_component_content_id(_0: number, _1: number, _2: number): void;
  ...
  _heif_context_set_write_mini_format(_0: number, _1: number): void;
  ...
  _heif_image_get_number_of_used_components(_0: number): number;
  _heif_image_get_used_component_ids(_0: number, _1: number): void;
  _heif_image_get_component_channel(_0: number, _1: number): number;
  _heif_image_get_component_width(_0: number, _1: number): number;
  _heif_image_get_component_height(_0: number, _1: number): number;
  _heif_image_get_component_bits_per_pixel(_0: number, _1: number): number;
  _heif_image_get_component_type(_0: number, _1: number): number;
  _heif_image_get_component_datatype(_0: number, _1: number): number;
  _heif_image_handle_get_number_of_components(_0: number): number;
  _heif_image_handle_get_used_component_ids(_0: number, _1: number): void;
  _heif_image_handle_get_component_type(_0: number, _1: number): number;
  _heif_image_handle_get_component_bits_per_pixel(_0: number, _1: number): number;
  _heif_image_handle_get_component_datatype(_0: number, _1: number): number;
  _heif_image_add_component(_0: number, _1: number, _2: number, _3: number, _4: number, _5: number, _6: number, _7: number): void;
  _heif_image_get_component_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_uint16_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_uint16(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_uint32_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_uint32(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_uint64_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_uint64(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int8_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int8(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int16_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int16(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int32_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int32(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int64_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_int64(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_float32_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_float32(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_float64_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_float64(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_complex32_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_complex32(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_complex64_readonly(_0: number, _1: number, _2: number): number;
  _heif_image_get_component_complex64(_0: number, _1: number, _2: number): number;
  _heif_image_set_gimi_component_content_id(_0: number, _1: number, _2: number, _3: number): void;
  ...
  _heif_image_handle_get_omaf_image_projection(_0: number): number;
  _heif_image_handle_set_omaf_image_projection(_0: number, _1: number): void;
  _heif_image_get_omaf_image_projection(_0: number): number;
  _heif_image_set_omaf_image_projection(_0: number, _1: number): void;
...
export type heif_chroma = heif_chromaValue<99>|heif_chromaValue<0>|heif_chromaValue<1>|heif_chromaValue<2>|heif_chromaValue<3>|heif_chromaValue<10>|heif_chromaValue<11>|heif_chromaValue<12>|heif_chromaValue<13>|heif_chromaValue<14>|heif_chromaValue<15>|heif_chromaValue<0>|heif_chromaValue<10>|heif_chromaValue<11>;
...
export type heif_colorspace = heif_colorspaceValue<99>|heif_colorspaceValue<0>|heif_colorspaceValue<1>|heif_colorspaceValue<2>|heif_colorspaceValue<4>|heif_colorspaceValue<3>|heif_colorspaceValue<3>;

export interface heif_channelValue<T extends number> {
  value: T;
}
export type heif_channel = heif_channelValue<0>|heif_channelValue<2>|heif_channelValue<1>|heif_channelValue<3>|heif_channelValue<4>|heif_channelValue<5>|heif_channelValue<6>|heif_channelValue<10>|heif_channelValue<11>|heif_channelValue<12>|heif_channelValue<13>|heif_channelValue<65535>;
...
interface EmbindModule {
  ...
  heif_image_handle_has_alpha_channel(_0: heif_image_handle): number;
  heif_image_handle_is_premultiplied_alpha(_0: heif_image_handle): number;
  heif_context_get_number_of_items(_0: heif_context): number;
  heif_get_version_number(): number;
  heif_item_is_item_hidden(_0: heif_context, _1: number): number;
  ...
  heif_context_get_list_of_top_level_image_IDs(_0: heif_context): any;
  heif_context_get_image_handle(_0: heif_context, _1: number): any;
  heif_context_get_primary_image_handle(_0: heif_context): any;
  heif_js_decode_image2(_0: heif_image_handle, _1: heif_colorspace, _2: heif_chroma): any;
  heif_context_get_list_of_item_IDs(_0: heif_context): any;
  heif_item_get_item_type(_0: heif_context, _1: number): any;
  heif_item_get_mime_item_content_type(_0: heif_context, _1: number): any;
  heif_item_get_mime_item_content_encoding(_0: heif_context, _1: number): any;
  heif_item_get_uri_item_uri_type(_0: heif_context, _1: number): any;
  heif_item_get_item_name(_0: heif_context, _1: number): any;
